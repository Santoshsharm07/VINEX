...
<html lang="en">
 ...
 <div>
	...
	<%
        ...
        <form action="deleteitem_hostel_DAO.jsp" method="post">
            <center>
                <br><br>   
            <label for="uname"><strong>Enter Id :</strong></label>
           <input type="number" placeholder="Enter Id to Delete Item" name="id" required>
