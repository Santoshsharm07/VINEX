...
<html lang="en">
  ...
  <br><br><br><br>
      ...
      <form action="register_hostel_DAO.jsp" method="post">
        ...
        <div class="container">
          ...
          <input type="text" placeholder="Enter Your Enrollment No." name="eno" required>

         
          <input type="number" placeholder="Enter Your Phone No." name="pno" required>
          
          <input type="text" placeholder="Enter Your Hostel Name" name="hname" required>
          
          <input type="text" placeholder="Enter Your Room No." name="rno" required>
        ...
        <a href="login_hostel.jsp">Already Register! Login</a>
      </form>
